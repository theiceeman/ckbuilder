...
This log documents all activities and learnings for Week 1, including environment setup and foundational CKB concepts. Future weeks will build on this foundation with hands-on development and experimentation.

## 4. Practical Operation: Wallet, Cells, and Blocks
- Connected to the CKB testnet using a wallet (MetaMask or similar).
